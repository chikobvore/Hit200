...
<html lang="en">
  <head>
    ...
    <title>Project Assessments</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body"><center><p style="color: red; font: 36px;"><b><?php if (!empty($_SESSION['message'])) {
              echo $_SESSION['message'];
            }else{ echo " ";} ?></center></p></b>
              <form method='POST' action='../php/Assess.php'>
                  <?php assessments($_SESSION['Department']); ?>
              </form>
