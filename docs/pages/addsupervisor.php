  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      ...
      <div class="row">
        ...
        <?php addsupervisor() ?>
        <?php
        if(isset($_POST['id']) && isset($_POST['supervisor']))
            {
                $supervisor = $_POST['supervisor'];
                $Project_id = $_POST['id'];
                $sql = "UPDATE projects SET Supervisor = '$supervisor' WHERE Project_id = '$Project_id'";
                if ($Conn->query($sql) === FALSE)
                {
                    session_start();
                    $_SESSION['message'] = 'Sorry Operation failed';
                    header('location : ../pages/addsupervisor.php');
                }
            }
        ?>
        </div>
